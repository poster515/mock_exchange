#include "gateway/SbeInboundThread.h"
...
namespace gateway {
        ...
        SbeInboundThread::SbeInboundThread() {

        }

        bool SbeInboundThread::Initialize() {
        ...
        size_t SbeInboundThread::PollOnce() {
        ...
        void SbeInboundThread::StopPolling() {
